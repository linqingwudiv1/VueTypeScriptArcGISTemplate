...
import Home from '@/components/DevNav/index.vue'
      ...
      children: [
        {
          path: '/index',
          name: 'index',
          component: function(resolve:any ){ require(['@/components/DevNav/component/home.vue'], resolve);} //index
        },
        {
          path: '/gismapexam',
          name: 'gismapexam',
          component: function(resolve:any ){ require(['@/components/DevNav/component/GisMapExam/index.vue'], resolve);} //gismapexam //() => import('@/components/DevHome/component/GisMapExam/index.vue') gismapexam
        },
        {
          path: '/DataTable',
          name: 'DataTable',
          component: function(resolve:any ){ require(['@/components/DevNav/component/DataTable/index.vue'], resolve);}  //DataTable //() => import('@/components/DevHome/component/DataTable/index.vue')  
        },
        {
          path: '/threeExam',
          name: 'threeExam',
